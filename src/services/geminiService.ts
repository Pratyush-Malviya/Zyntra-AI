...
export async function generateCrmHelp(actionType: "email_draft_assist" | "call_notes_assist" | "lead_deal_score", payload: any): Promise<any> {
  return fetchSecureGemini('/api/gemini/crm-help', { actionType, payload });
}
