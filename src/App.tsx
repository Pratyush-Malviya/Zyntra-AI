...
function MainApp({ user, profile, theme, setTheme }: { user: any; profile: UserProfile; theme: 'dark' | 'light'; setTheme: (t: 'dark' | 'light') => void }) {
  ...
  return (
    <div className="min-h-screen bg-bg-primary text-text-primary flex">
      {/* Sidebar */}
      <aside className={`fixed md:relative z-40 h-full bg-bg-secondary border-r border-border transition-all ${isMobileMenuOpen ? 'left-0' : '-left-64 md:left-0'} md:w-56 w-64`}>
